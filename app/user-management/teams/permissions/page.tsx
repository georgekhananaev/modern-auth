...
export default function TeamPermissionsPage() {
  return (
    <ComingSoon 
      ...
      starsGoal={190}
      additionalContent={
        <div className="p-4 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/30 dark:to-indigo-900/20 rounded-lg border border-purple-100 dark:border-purple-800/50 text-left">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-md p-3 shadow-sm mb-3">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="text-[10px] px-1.5 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-full">
                Active
              </div>
            </div>
          ...
          <div className="text-xs text-center italic opacity-70 mb-1">Coming with powerful permission management tools</div>
        </div>
      }
    />
  );
