  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mb-8 rounded-lg shadow-md p-6" style={{
        ...
        <p className="mb-4">
          The Navbar component is a responsive, feature-rich navigation bar that supports multi-level dropdowns,
          user authentication states, theme toggling, and mobile responsiveness. It&apos;s designed to provide a 
        ...
        <div className="mb-6">
          <p className="mb-2 text-sm">
            The Navbar component uses a nested structure for menu items. Each item can have children for submenu dropdowns.
          </p>
          <ThemedPreElement>
            {navLinkStructure}
          </ThemedPreElement>
        ...
        <p className="mb-4">
          To customize the navigation items, you&apos;ll need to modify the <code>initialNavLinks</code> array in the Navbar component.
