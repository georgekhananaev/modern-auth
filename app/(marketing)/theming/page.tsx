            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-12">
                    ...
                    <p className="text-lg opacity-80">
                        Modern Auth&apos;s powerful theming engine creates a seamless experience across light and dark
                        modes
                    </p>
                </div>
                ...
                <div className="space-y-16">
                    ...
                    <section>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <p>
                                    Our theming system is engineered for maximum flexibility and developer experience,
                                    addressing common pain points in dark mode implementation:
                                </p>
                                ...
                                <p>
                                    Built on CSS variables and Tailwind CSS, the theming system provides fine-grained
                                    control while maintaining consistent visual hierarchy in both light and dark modes.
                                </p>
                            </div>
                  ...
                  <pre className="whitespace-pre-wrap">
                    ...
                    <section>
                        ...
                        <p className="mb-6">
                            Modern Auth&apos;s components automatically adapt to the current theme without any
                    ...
                    <section className="mt-16">
                        ...
                        <p className="mb-6">
                            Our toast notification system provides contextual feedback while automatically adapting to
                                ...
                                <div className="bg-primary/10 dark:bg-primary/5 border rounded-lg p-6">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center">
                                            ...
                                            <span
                                                className="ml-2 opacity-70">- For critical issues requiring attention</span>
                                        </div>
                                        <div className="flex items-center">
                                            <div
                                                className="w-3 h-3 rounded-full bg-amber-500 dark:bg-amber-400 mr-2"></div>
                                            <span className="font-medium">Warning</span>
                                            <span
                                                className="ml-2 opacity-70">- For important but non-critical notices</span>
                                        </div>
                                        <div className="flex items-center">
                                            <div
                                                className="w-3 h-3 rounded-full bg-green-600 dark:bg-green-500 mr-2"></div>
                                            <span className="font-medium">Success</span>
                                            <span
                                                className="ml-2 opacity-70">- For confirmed actions or operations</span>
                                        </div>
                                        <div className="flex items-center">
                                            <div
                                                className="w-3 h-3 rounded-full bg-blue-600 dark:bg-blue-500 mr-2"></div>
                                            <span className="font-medium">Info</span>
                                            <span
                                                className="ml-2 opacity-70">- For general information or updates</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                  ...
                  <pre className="whitespace-pre-wrap">
                    <code>
                      <span className="text-green-600 dark:text-green-400">{`// Toast usage in components`}</span>
                        ...
                        {"}"}{"\n\n"}
                        <span
                            className="text-green-600 dark:text-green-400">{`// Toast automatically adapts to theme`}</span>{"\n"}
                    ...
                    <section>
                        ...
                        <div className="border rounded-lg overflow-hidden">
                            <div className="p-6 bg-primary/5 dark:bg-primary/10">
                                <p className="mb-4">
                                    Modern Auth&apos;s theming system is designed to be completely customizable while
                            ...
                            <div className="p-6 border-t">
                                ...
                                <div className="font-mono text-sm p-4 bg-primary/5 dark:bg-primary/10 rounded-md">
                                    <div>
                                        <span
                                            className="text-green-600 dark:text-green-400">{`/* globals.css */`}</span>{"\n"}
                                        :root {"{"}{"\n"}
                    ...
                    <div className="bg-primary/10 dark:bg-primary/5 rounded-xl p-8 text-center mt-16">
                        ...
                        <p className="text-lg opacity-80 mb-8 max-w-2xl mx-auto">
                            Add beautiful, accessible authentication with flawless theme support to your Next.js app in
                            minutes.
                        </p>
