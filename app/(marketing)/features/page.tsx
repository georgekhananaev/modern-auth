    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-16">
          ...
          <section className="border rounded-lg p-8 shadow-sm">
            <h2 className="text-2xl font-bold mb-4">Enterprise-grade Authentication</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p>
                  Modern Auth provides a battle-tested authentication infrastructure built on industry standards and
              ...
              <div className="bg-primary/10 dark:bg-primary/5 rounded-lg p-6">
                <p className="font-mono text-sm opacity-80">
                  <span className="text-green-600 dark:text-green-400">{/* Modern JWT implementation with key rotation */}</span><br />
                  import {`{ jwtService }`} from &apos;@modern-auth/core&apos;;<br /><br />
                  
                  <span className="text-green-600 dark:text-green-400">{/* Create a token with claims */}</span><br />
                  ...
                  <span className="text-green-600 dark:text-green-400">{/* Verify with advanced validation */}</span><br />
                  try {`{`}<br />
                  ...
                  {`}`} catch (error) {`{`}<br />
                  &nbsp;&nbsp;logger.security.warn(&apos;Invalid token&apos;, {`{ error, token: tokenMask(token) }`});<br />
          ...
          <section className="border rounded-lg p-8 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p>
                  Modern Auth delivers comprehensive identity and access management for organizations of any size.
                  Our system handles millions of users with enterprise-ready performance and compliance.
                </p>
                <ul className="list-disc list-inside space-y-2 opacity-80">
              ...
              <div className="bg-primary/10 dark:bg-primary/5 rounded-lg p-6">
                <p className="font-mono text-sm opacity-80">
                  <span className="text-green-600 dark:text-green-400">{/* Enterprise User Model */}</span><br />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 opacity-80">
                  ...
                  <li>Persistent theme settings with local storage and server-side preference sync</li>
              ...
              <div className="bg-primary/10 dark:bg-primary/5 rounded-lg p-6">
                <p className="font-mono text-sm opacity-80">
                  <span className="text-green-600 dark:text-green-400">{/* Modern theme architecture */}</span><br />
                  import {`{ createThemeContext }`} from &apos;@modern-auth/theme&apos;;<br /><br />
                  
                  <span className="text-green-600 dark:text-green-400">{/* Define theme variants */}</span><br />
                  const themeConfig = {`{`}<br />
                  &nbsp;&nbsp;variants: [&apos;light&apos;, &apos;dark&apos;, &apos;highContrast&apos;],<br />
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;text: &apos;#111827&apos;,<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/* Additional token definitions */<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{`}`}<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;{`}`},<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;dark: {`{`}<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;colors: {`{`}<br />
                  ...
                  <span className="text-green-600 dark:text-green-400">{/* Create theme context */}</span><br />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="pt-4 relative error-menu-container">
                  ...
                  {isErrorMenuOpen && (
                    <div className="absolute mt-2 left-0 z-50 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 transition-all duration-200 animate-fadeIn error-menu-container">
                      <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                        <h3 className="font-medium text-sm">Error Page Examples</h3>
                      </div>
                      <div className="py-1">
                        <Link href="/not-found" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                          404 - Not Found
                        </Link>
                        <Link href="/error?code=401" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                          401 - Unauthorized
                        </Link>
                        <Link href="/error?code=403" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                          403 - Forbidden
                        </Link>
                        <Link href="/error?code=500" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                          500 - Server Error
                        </Link>
                        <Link href="/error?code=503" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
              ...
              <div className="bg-primary/10 dark:bg-primary/5 rounded-lg p-6">
                <p className="font-mono text-sm opacity-80">
                  <span className="text-green-600 dark:text-green-400">{/* Centralized error handling */}</span><br />
                  import {`{ createErrorHandler }`} from &apos;@modern-auth/errors&apos;;<br /><br />
                  
                  <span className="text-green-600 dark:text-green-400">{/* Define app error types */}</span><br />
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;code: &apos;VAL_001&apos;,<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status: 400,<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: &apos;Required field missing&apos;<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{`}`},<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;{`}`}<br />
                  &nbsp;&nbsp;{`}`},<br />
                  &nbsp;&nbsp;defaultError: {`{`}<br />
                  ...
                  <span className="text-green-600 dark:text-green-400">{/* Create error handler */}</span><br />
          ...
          <div className="bg-primary/10 dark:bg-primary/5 rounded-xl p-8 text-center">
            ...
            <p className="text-lg opacity-80 mb-8 max-w-2xl mx-auto">
              Join thousands of developers building secure, enterprise-ready applications with Modern Auth&apos;s authentication platform.
            </p>
            <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 flex-wrap justify-center sm:gap-4 max-w-lg mx-auto">
