...
export default function UserRolesPage() {
  return (
    <ComingSoon 
      ...
      starsGoal={170}
      additionalContent={
        <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/20 rounded-lg border border-blue-100 dark:border-blue-800/50 text-left">
