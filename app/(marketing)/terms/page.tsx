      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10 p-6 rounded-xl bg-primary/10 dark:bg-primary/5">
          ...
          <ul className="space-y-2 text-sm grid md:grid-cols-2">
            ...
            <li>
              <a href="#intellectual-property" className="text-primary hover:underline">5. Intellectual Property</a>
            </li>
            <li>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section id="introduction" className="mb-10">
            <div className="p-6 rounded-lg bg-primary/10 dark:bg-primary/5 border border-primary/10">
              <p className="text-lg leading-relaxed">
                Welcome to Modern Auth. These Terms of Service (&quot;Terms&quot;) govern your access to and use of our 
                website and services. By accessing or using Modern Auth, you agree to be bound by these Terms.
              </p>
            </div>
          </section>
          ...
          <section id="description" className="mb-10">
            ...
            <div className="pl-4 border-l-2 border-primary/20 ml-5">
              <p>
                Modern Auth provides authentication and user management services for web applications. Our service 
                includes user registration, login, password management, and related features to help developers 
          ...
          <section id="intellectual-property" className="mb-10">
            ...
            <div className="pl-4 border-l-2 border-primary/20 ml-5">
              <div className="bg-yellow-50 dark:bg-yellow-900/10 border-l-4 border-yellow-400 dark:border-yellow-600 p-4 my-4">
                <p className="text-yellow-800 dark:text-yellow-200">
                  The service and its original content, features, and functionality are owned by Modern Auth and 
          ...
          <section id="liability" className="mb-10">
            ...
            <div className="pl-4 border-l-2 border-primary/20 ml-5">
              <p>
                In no event shall Modern Auth, its directors, employees, partners, agents, suppliers, or affiliates 
          ...
          <section id="contact" className="mb-10">
            ...
            <div className="pl-4 border-l-2 border-primary/20 ml-5">
              ...
              <div className="mt-4 p-4 rounded-lg bg-primary/5 inline-block">
                <a href="mailto:legal@modern-auth.example.com" className="text-primary font-medium hover:underline flex items-center gap-2">
