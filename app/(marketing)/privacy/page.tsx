      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10 p-6 rounded-xl bg-primary/10 dark:bg-primary/5">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="#cookies" className="text-primary hover:underline">Cookies and Tracking Technologies</a>
            </li>
            <li>
              <a href="#third-party" className="text-primary hover:underline">Third-Party Services</a>
            </li>
            <li>
              <a href="#childrens-privacy" className="text-primary hover:underline">Children&apos;s Privacy</a>
            </li>
            <li>
              <a href="#changes" className="text-primary hover:underline">Changes to This Privacy Policy</a>
            </li>
            <li>
          ...
          <section id="third-party" className="mb-10">
            ...
            <div className="pl-4 border-l-2 border-primary/20 ml-5">
              <p>
                ...
                by Modern Auth. We have no control over, and assume no responsibility for, the content, privacy policies, 
          ...
          <section id="contact" className="mb-10">
            ...
            <div className="pl-4 border-l-2 border-primary/20 ml-5">
              ...
              <div className="mt-4 p-4 rounded-lg bg-primary/5 inline-block">
                <a href="mailto:privacy@modern-auth.example.com" className="text-primary font-medium hover:underline flex items-center gap-2">
