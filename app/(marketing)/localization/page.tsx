...
export default function LocalizationPage() {
    return (
        <ComingSoon
            ...
            additionalContent={
                <div
                    className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/50 text-left">
                    <div>
