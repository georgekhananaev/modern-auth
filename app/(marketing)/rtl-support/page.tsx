...
export default function RtlSupportPage() {
    return (
        <ComingSoon
            ...
            additionalContent={
                <div
                    className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-800/50 text-left">
              ...
              <span className="text-purple-600 dark:text-purple-400">🌍</span>
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-3">
                        <div className="flex items-center space-x-2">
                            <div
                                className="w-4 h-4 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0">
