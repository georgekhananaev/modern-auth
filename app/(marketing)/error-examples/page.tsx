                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
                    ...
                    >
                        <div className="flex items-center mb-3">
                            <div
                                className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800/30 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                  ...
                  <path d="m12 5 7 7-7 7"/>
                    ...
                    >
                        <div className="flex items-center mb-3">
                            <div
                                className="w-10 h-10 rounded-full bg-yellow-100 dark:bg-yellow-800/30 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                  ...
                  <path d="m12 5 7 7-7 7"/>
                    ...
                    >
                        <div className="flex items-center mb-3">
                            <div
                                className="w-10 h-10 rounded-full bg-red-100 dark:bg-red-800/30 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
