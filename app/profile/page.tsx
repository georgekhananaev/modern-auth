...
export default async function ProfilePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {isDemoMode && (
        <div className="max-w-2xl mx-auto mb-6 p-4 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg text-amber-700 dark:text-amber-300">
