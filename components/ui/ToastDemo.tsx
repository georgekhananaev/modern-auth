...
export default function ToastDemo() {
    ...
    return (
        <ThemedContainer padding="lg" className="space-y-6">
            <div>
            ...
            <ThemedBox border="top" className="pt-6">
                ...
                {!isDemoMode && (
                    <ThemedContainer
                        variant="borderless"
                        className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300"
                        shadow="none"
                    >
                        <p className="text-sm font-medium">Demo mode is not enabled</p>
                        <p className="text-sm mt-1">
                            Set <code className="bg-amber-100 dark:bg-amber-800 px-1 py-0.5 rounded">DEMO=true</code> in
                            your environment variables to test demo mode toasts.
                        </p>
                    </ThemedContainer>
                )}
            </ThemedBox>
