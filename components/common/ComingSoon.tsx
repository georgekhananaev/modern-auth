...
export default function ComingSoon({
    ...
    return (
        <div
            className="w-full min-h-[70vh] flex flex-col items-center justify-center px-4 py-16 relative overflow-hidden">
                    ...
                    {!formState.notified ? (
                        <div>
                            <div className="mb-3">
                                ...
                                <p className="text-xs italic mb-2"
                                   style={{color: isDarkMode ? 'rgb(156, 163, 175)' : 'rgb(107, 114, 128)'}}>
                                    Help us reach our GitHub star goal! <a href={GITHUB_REPO_URL} target="_blank"
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p className="text-xs mt-1">Don&apos;t forget to <a href={GITHUB_REPO_URL}
                                                                                    target="_blank"
                                                                                    rel="noopener noreferrer"
                                                                                    className="font-medium hover:underline">star
                                    us on GitHub</a> to help us reach our goal!</p>
                            </div>
                        </div>
                    )}
                </div>
